...
@Component({
  selector: 'app-response-execution',
  standalone: true,
  imports: [CommonModule, ButtonComponent, FormsModule],
  templateUrl: './response-execution-component.html',
  styleUrl: './response-execution-component.css'
})
export class ResponseExecutionComponent implements OnInit, OnChanges {
